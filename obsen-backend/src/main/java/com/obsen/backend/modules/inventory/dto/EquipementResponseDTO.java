...
public class EquipementResponseDTO {
    ...
    private List<EquipementRequestDTO> assets;
    ...
    public List<EquipementRequestDTO> getAssets() { return assets; }
    public void setAssets(List<EquipementRequestDTO> assets) { this.assets = assets; }
}